...
/*
 * This file is derived from Granite (https://github.com/elementary/granite)
 *
 * Original copyright:
 * Copyright 2011–2023 elementary, Inc.
 *
 * Modifications for Tuner:
 * Copyright © 2026 technosf <https://github.com/technosf>
 *
 ...
 *
 * {{{
 * var library_category = new SourceList.ExpandableItem ("Libraries");
 * var store_category = new SourceList.ExpandableItem ("Stores");
 * var device_category = new SourceList.ExpandableItem ("Devices");
 *
 * var music_item = new SourceList.Item ("Music");
 *
 ...
 * var my_store_item = new SourceList.ExpandableItem ("My Store");
 * store_category.add (my_store_item);
 *
 * var my_store_podcast_item = new SourceList.Item ("Podcasts");
 * var my_store_music_item = new SourceList.Item ("Music");
 *
 * my_store_item.add (my_store_music_item);
 * my_store_item.add (my_store_podcast_item);
 *
 * var player1_item = new SourceList.Item ("Player 1");
 * var player2_item = new SourceList.Item ("Player 2");
 *
 ...
 * }}}
 *
 * 3. Add root-level items to the {@link SourceList.root} item.
 ...
 * {@link SourceList.item_selected} the most important, as it indicates that
 ...
 */
    public class SourceList : Gtk.ScrolledWindow
    {
        ...
        public class Item : Object
        {
             ...
             * to the {@link SourceList.Item.name} property. The default behavior can
            ...
            /**
             * The {@link SourceList.Item.activatable} icon was activated.
             *
             * @see SourceList.Item.activatable
             * @since 0.2
             */
            ...
            /**
             * Parent {@link SourceList.ExpandableItem} of the item.
             * ''Must not'' be modified.
             *
             * @since 0.2
             */
            public ExpandableItem parent
            {
                get; internal set;
            }
             ...
             * contents of the {@link SourceList.Item.name} property.
             *
             * @since 5.3
             */
            ...
            /**
             * Markup to be used instead of {@link SourceList.ExpandableItem.name}
             * This would mean that &, <, etc have to be escaped in the text, but basic formatting
             * can be done on the item with HTML style tags.
             *
             * Note: Only the {@link SourceList.ExpandableItem.name} property
             ...
             *
             * @see SourceList.Item.selectable
             * @see SourceList.start_editing_item
             * @since 0.2
             */
             ...
             * item's {@link SourceList.Item.visible} property; whether the item is
             * a category; the parent item is collapsed, etc.
             *
             * @see SourceList.Item.visible
             * @since 0.2
             */
             ...
             *
             * @see SourceList.Item.action_activated
             * @since 0.2
             */
            public Icon activatable
            {
                get; set;
            }
             ...
             * @since 5.0
             */
            public string activatable_tooltip
            {
                get; set; default = "";
            }

            /**
             * Creates a new {@link SourceList.Item}.
             *
             * @param name Name of the item.
             * @return (transfer full) A new {@link SourceList.Item}.
             * @since 0.2
             */
         ...
         *
         * It supports all the properties inherited from {@link SourceList.Item},
         ...
         *
         * * {@link SourceList.Item.selectable}
         * * {@link SourceList.Item.editable}
         * * {@link SourceList.Item.icon}
         * * {@link SourceList.Item.activatable}
         * * {@link SourceList.Item.badge}
         *
        ...
        public class ExpandableItem : Item
        {
             ...
             * @see SourceList.ExpandableItem.add
             * @since 0.2
             */
             ...
             * @see SourceList.ExpandableItem.remove
             * @since 0.2
             */
             ...
             * {@link SourceList.ExpandableItem.expanded} property.
             *
             * @see SourceList.ExpandableItem.expanded
             * @since 0.2
             */
             ...
             *
             * This property has no effect when {@link SourceList.ExpandableItem.collapsible}
             ...
             * use {@link SourceList.is_item_expanded} instead.
             *
             * @see SourceList.ExpandableItem.collapsible
             * @see SourceList.is_item_expanded
             * @since 0.2
             */
             ...
             * {@link SourceList.ExpandableItem.remove}
             *
             * @since 0.2
             */
            ...
            /**
             * Creates a new {@link SourceList.ExpandableItem}
             *
             * @param name Title of the item.
             * @return (transfer full) A new {@link SourceList.ExpandableItem}.
             * @since 0.2
             */
             ...
             * Adds an item.
             *
             * {@link SourceList.ExpandableItem.child_added} is fired after the item is added.
             *
             ...
             * @see SourceList.ExpandableItem.child_added
             * @see SourceList.ExpandableItem.remove
             * @since 0.2
             */
             ...
             * Removes an item.
             *
             * The {@link SourceList.ExpandableItem.child_removed} signal is fired
             * //after removing the item//. Finally (i.e. after all the handlers have been invoked),
             * the item's {@link SourceList.Item.parent} property is set to //null//.
             ...
             * @see SourceList.ExpandableItem.child_removed
             * @see SourceList.ExpandableItem.clear
             * @since 0.2
             */
            ...
            /**
             * Expands or collapses the item and/or its children.
             *
             * @param inclusive Whether to also expand/collapse this item (true), or only its children (false).
             * @param recursive Whether to recursively expand/collapse all the children (true), or only
             * immediate children (false).
             * @param expanded Whether to expand or collapse the item and/or its children.
             * @since 0.2
             */
        ...
        private class DataModel : Gtk.TreeModelFilter, Gtk.TreeDragSource, Gtk.TreeDragDest
        {
            ...
            private class NodeWrapper
            {
                ...
                public bool valid
                {
                    get
                    {
                        return row_reference != null && row_reference.valid ();
                    }
                } // valid
                ...
                /**
                 * Creates a new node wrapper for the given model and iterator.
                 */
            ...
            /**
             * The columns available in the model.
             */
            private enum Column
            {
                ITEM,
            ...
            /**
             * Starts listening for property changes on an item already tracked by the model.
             */
            ...
            } // add_property_monitor



            /**
             * Stops listening for property changes on a previously monitored item.
             */
            private void remove_property_monitor (Item item)
            {
                ...
                monitors.unset (item);
            } // remove_property_monitor



            /**
             * Hooks child add/remove signals so model rows stay synced with the item tree.
             */
            ...
            } // add_children_monitor



            /**
             * Unhooks child add/remove signals for items that are no longer model-managed.
             */
        ...
        private class Tree : Gtk.TreeView
        {
            ...
            public Pango.EllipsizeMode ellipsize_mode
            {
                get
                {
                    return text_cell.ellipsize;
                }
                set
                {
                    text_cell.ellipsize = value;
                }
            }
        ...
        """;
            ...
            construct
            {
                ...
                style_context.add_class ("source-list"); // FIXME
            ...
            public override void cursor_changed ()
            {
                ...
                Item? new_item = path != null ? data_model.
                                 get_item_from_path (path) : null;
            ...
            private bool over_primary_expander (Gtk.TreeViewColumn col, Gtk.TreePath path, int x)
            {
                ...
                return false;
            } // over_primary_expander


            /**
             * Returns whether the pointer x-coordinate overlaps the target cell renderer.
             */
            ...
            /**
             * Returns the minimum preferred width for a renderer in this tree view.
             */
            ...
            /**
             * Shows the item context menu for an explicit item or the current selection.
             */
            ...
            /**
             * Extracts a SourceList item from a model iter when the model is a DataModel.
             */
            ...
            /**
             * Controls spacer visibility so only indenters up to the row depth are shown.
             */
        ...
        /**
         * A {@link SourceList.VisibleFunc} should return true if the item should be
         * visible; false otherwise. If //item//'s {@link SourceList.Item.visible}
         ...
         * itself again.
         *
         * For most use cases, modifying the {@link SourceList.Item.visible} property is enough.
         *
         * The advantage of using this method is that its nature is non-destructive, and the
         * changes it makes can be easily reverted (see {@link SourceList.refilter}).
         *
         ...
         *
         * Internally, it allows the source list to connect to its {@link SourceList.ExpandableItem.child_added}
         * and {@link SourceList.ExpandableItem.child_removed} signals in order to monitor
         ...
         * {@link SourceList.ExpandableItem.expand_with_parents} is called on the
        ...
        public Pango.EllipsizeMode ellipsize_mode
        {
            get
            {
                return tree.ellipsize_mode;
            }
            set
            {
                tree.ellipsize_mode = value;
            }
        }
        ...
        /**
         * Creates a new {@link SourceList}.
         *
         * @return A new {@link SourceList}.
         * @since 0.2
         */
         ...
         * @param refilter Whether to call {@link SourceList.refilter} using the new function.
         * @see SourceList.VisibleFunc
         * @see SourceList.refilter
         * @since 0.2
         */
        ...
        /**
         * Applies the filter method set by {@link SourceList.set_filter_func}
         * to all the items that are part of the current tree.
         *
         * @see SourceList.VisibleFunc
         * @see SourceList.set_filter_func
         * @since 0.2
         */
         ...
         * @see SourceList.Item.editable
         * @see SourceList.editing
         * @see SourceList.stop_editing
         ...
         * @see SourceList.disable_drag_source
         * @since 0.3
         */
        ...
        /**
         * Undoes the effect of {@link SourceList.enable_drag_source}
         *
         * @see SourceList.enable_drag_source
         * @since 0.3
         */
         ...
         * @see SourceList.disable_drag_dest
         * @since 0.3
         */
        ...
        /**
         * Undoes the effect of {@link SourceList.enable_drag_dest}
         *
         * @see SourceList.enable_drag_dest
         * @since 0.3
         */
         ...
         *
         * {@link SourceList.ExpandableItem.expand_with_parents} is called
